...
class Wallet:
    def __init__(self, node_id):
        ...
        self.data_path = path.join(
            'data/wallets/', 'wallet-{}.txt'.format(self.node_id))
        create_dirs('data/wallets')
    ...
    def generate_keys(self):
        ...
        return (convert_key(private_key), convert_key(public_key))

    def sing_transaction(self, sender, recipient, amount):
